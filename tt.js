...
function fetchRecordsFromTo(appId,ready, from, to, opt_offset, opt_limit, opt_records) {
    ...
    return kintone.api('/k/v1/records', 'GET', params).then(function (resp) {
        ...
        if (resp.records.length === limit) {
            return fetchRecordsFromTo(appId,ready, from, to, offset + limit, limit, allRecords);
        }
        else ready = true;
        return allRecords;
    });
